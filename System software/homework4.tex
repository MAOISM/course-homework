...
\LARGE\textit{E-R diagrams Homework}
...
\section{Problem 1}
Draw an E-R diagram to describe the above scenario.\\

\section{Problem 2}
\begin{itemize}
\item[a]  Can a stall buy the same kind of vegetable from different farms?  And why?
\item[b]  Do some farms not supply any vegetable to any Stall? And why?   
\end{itemize}
\end{document}
